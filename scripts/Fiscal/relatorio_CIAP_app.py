# ===== ANALISADOR SPED FISCAL v2.3 - BLOCO G (CIAP COM DESCRIÇÃO DO 0300) =====
        ...
        with open(filepath, 'r', encoding='latin-1') as f:
            for line in f:
                ...
                if reg == '0000' and nome_arquivo not in mapa_empresa:
                    ...
                    # CORREÇÃO: Mapeia a descrição do bem a partir do registro 0300
        ...
        with open(filepath, 'r', encoding='latin-1') as f:
            ...
            for line in f:
                ...
                if reg == 'G125':
                    ...
                    # CORREÇÃO: Busca a descrição no mapa de bens do CIAP (0300)
