...
try:
    from scripts.Contabilidade.sistemas import fuga, uniair, uniodontofederacao, girandosol, useall
except ModuleNotFoundError:
    from sistemas import fuga, uniair, uniodontofederacao, girandosol, useall
